...
find etc -type d -print0 | xargs -0 -i__FNAME__ mkdir -p 'build/__FNAME__'
find etc -type f -print0 | xargs -0 -i__FNAME__ sed "s~__INSTALLDIR__~${INSTALLDIR}~g" < '__FNAME__' 'build/__FNAME__'
